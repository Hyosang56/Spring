...
//	            args.add(adminMemberVo.getA_m_pw() );
	      ...
	      return result;      
	   }//end of  insertAdminAccount()
	public AdminMemberVo selectAdmin(AdminMemberVo 
	         adminMemberVo) {
	      ...
	      List<AdminMemberVo> adminMemberVos = 
	      new ArrayList<AdminMemberVo>();
	      
	      try {
	      
	      adminMemberVos = 
	      jdbcTemplate.query(sql, new RowMapper<AdminMemberVo>() 
	      {
	      
	         @Override
	         public AdminMemberVo mapRow(ResultSet rs, 
...
//	      if (! adminMemberVo.getA_m_pw().equals( 
//	              adminMemberVos.get(0).getA_m_pw() ) )
//	                 adminMemberVos.clear();
	...
	public AdminMemberVo selectAdmin(String a_m_id, String a_m_name, 
	         String a_m_mail) {
	      System.out.println("[AdminMemberDao] selectAdmin()");
	   ...
	   }//end of selectAdmin(String a_m_id, String a_m_name, String a_m_mail)
	...
	public int updatePassword(String a_m_id, String newPassword) {
	      ...
	      return result;
	   }//end of int updatePassword(String a_m_id, String newPassword)
